...
function redirectToMode(mode) {
    ...
    switch (mode) {
        case 'mode1':
            window.location.href = 'http://127.0.0.1/typing/small?mode='+autoGenerateToggle.checked; // モード1のURL
            break;
        case 'mode2':
            window.location.href = 'http://127.0.0.1/typing/default?mode='+autoGenerateToggle.checked; // モード2のURL
            break;
        case 'mode3':
            window.location.href = 'http://127.0.0.1/typing/default2?mode='+autoGenerateToggle.checked; // モード3のURL
            break;
        default:
            break;
    }
